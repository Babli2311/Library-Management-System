...
import BookReports from "./pages/reports/BookReports";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/books/update" element={<ProtectedRoute element={<UpdateBook />} requiredRole="admin" />} />
            ...
            <Route path="/reports/books" element={<ProtectedRoute element={<BookReports />} requiredRole="admin" />} />
